...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    {
        NSLog(@"New device in use!");
        self.viewController = [[BullsEyeViewController alloc] initWithNibName:@"BullsEyeViewController5" bundle:nil];
    }
    else
    {
        NSLog(@"Old device/iPad in use!");
